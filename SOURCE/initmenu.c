    ...
    while(1)
    {
        if(*page == 0)  //欢迎界面
        {
            ...
            while(*page == 0)
            {
                ...
                if(mouse_press(49, 400, 49 + 148, 430) == 2)  //鐧诲綍妗嗗唴鏈偣鍑?
                {
                    MouseS = 1;
                    if(*num == 0)
                    {
                ...
                else if(mouse_press(49, 400, 49 + 148, 430) == 1)  //鐐瑰嚮鐧诲綍妗?
                {
                    MouseS = 1;
                    *num = 1;
                    *page = 1;
                ...
                else if(mouse_press(49 + (148 + 49) * 1, 400, 49 + (148 + 49) * 1 + 148, 430) == 2)  //娉ㄥ唽妗嗗唴鏈偣鍑?
                {
                    MouseS = 1;
                    if(*num == 0)
                    {
                ...
                else if(mouse_press(49 + (148 + 49) * 1, 400, 49 + (148 + 49) * 1 + 148, 430) == 1)  //鐐瑰嚮娉ㄥ唽妗?
                {
                    MouseS = 1;
                    *num = 2;
                    *page = 2;
                ...
                else if(mouse_press(49 + (148 + 49) * 2, 400, 49 + (148 + 49) * 2 + 148, 430) == 2)  //閫�鍑烘鍐呮湭鐐瑰嚮
                {
                    MouseS = 1;
                    if(*num == 0)
                    {
                ...
                else if(mouse_press(49 + (148 + 49) * 2, 400, 49 + (148 + 49) * 2 + 148, 430) == 1)  //鐐瑰嚮閫�鍑?
                {
                    MouseS = 1;
                    delay(200);
                    exit(EXIT_SUCCESS);
...
void repaint(int *page, int *num)  //閲嶆柊缁樺埗鎸夐挳
{
    if(*page == 0)
    {
        setbkcolor(BLUE);
        ...
        clrmous(MouseX, MouseY);  //不清除鼠标会导致留下灰色斑块
...
void welcome_page()
{
    ...
    puthz(64, 64, "校园快递外卖模拟系统", 32, 36, WHITE);
    puthz(49, 400, "登录", 32, 36, WHITE);
    puthz(49 + 148 + 49, 400, "注册", 32, 36, WHITE);
    puthz(49 + 148 + 49 + 148 + 49, 400, "退出", 32, 36, WHITE);
